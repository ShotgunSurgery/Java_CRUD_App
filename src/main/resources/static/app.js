                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem' }}>
                        <thead>
                            <tr style={{ backgroundColor: '#f8f9fa' }}>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Parameter Name</th>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Data Type</th>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Range</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr key={index}>
                                    <td style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>
                                        <input
                                            ...
                                            style={{ width: '100%', padding: '0.5rem', border: '1px solid #ced4da', borderRadius: '3px' }}
                                        />
                                    </td>
                                    <td style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>
                                        <select
    ...
    return (
        <div className="dashboard">
            ...
            <div style={{ marginBottom: '2rem' }}>
                <button onClick={handleAddParameter} className="login-btn" style={{ marginRight: '1rem' }}>
                        ...
                        <thead>
                            <tr style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                {product.parameters.map(param => (
                                    <th key={param.id} style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>
                                        {param.parameterName}
                                    </th>
                                ))}
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                {product.parameters.map((param, index) => (
                                    <td key={param.id} style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>
                                        <input
                                            type="text"
                ...
                <div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem' }}>
                        <thead>
                            <tr style={{ backgroundColor: '#f8f9fa' }}>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Name</th>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Parameter</th>
                                <th style={{ padding: '0.75rem', border: '1px solid #dee2e6', textAlign: 'left' }}>Value</th>
                            </tr>
                        </thead>
                        <tbody>
                            {savedValues.map((value, index) => (
                                <tr key={index}>
                                    <td style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>{value.name}</td>
                                    <td style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>{value.parameterName}</td>
                                    <td style={{ padding: '0.75rem', border: '1px solid #dee2e6' }}>{value.value}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
...
function ProductList({ onProductSelect, onCreateNew }) {
    ...
    return (
        <div className="dashboard">
            ...
            <button onClick={onCreateNew} className="login-btn" style={{ marginBottom: '2rem' }}>
                Create New Product
            </button>
