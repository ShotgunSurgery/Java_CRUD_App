@echo off
echo ========================================
echo MySQL Setup and Verification Script (Fixed)
echo ========================================
echo.
...
"C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql" -u root -p -e "SELECT 'MySQL connection successful!' as status;"
if %errorlevel% equ 0 (
...
"C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql" -u root -p -e "CREATE USER IF NOT EXISTS 'root'@'localhost' IDENTIFIED BY 'root'; GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost'; FLUSH PRIVILEGES; CREATE DATABASE IF NOT EXISTS dummy2o;"

echo.
echo Step 4: Verifying database setup...
"C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql" -u root -p -e "USE dummy2o; SHOW TABLES;"
